...
- **Feature Extraction:** Utilizes `neurokit2` to extract meaningful features from raw signals.
- **Stress Prediction:** Uses a pre-trained model (and scaler) to predict user stress levels.
...
- `prediction.py`: Loads the model/scaler and returns stress predictions.
